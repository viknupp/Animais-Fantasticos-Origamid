...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initMenuMobile)\n/* harmony export */ });\n/* harmony import */ var _outside_click_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./outside-click.js */ \"./js/modules/outside-click.js\");\n\nfunction initMenuMobile() {\n  var menuButton = document.querySelector(\"[data-menu='button']\");\n  var menuList = document.querySelector(\"[data-menu='list']\");\n  var theEvents = [\"click\", \"touchstart\"];\n  function openMenu() {\n    menuList.classList.add(\"active\");\n    menuButton.classList.add(\"active\");\n    (0,_outside_click_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(menuList, theEvents, function () {\n      menuList.classList.remove(\"active\");\n      menuButton.classList.remove(\"active\");\n    });\n  }\n  if (menuButton) {\n    theEvents.forEach(function (userEvent) {\n      return menuButton.addEventListener(userEvent, openMenu);\n    });\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/menu-mobile.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initWorkHour)\n/* harmony export */ });\nfunction initWorkHour() {\n  var work = document.querySelector(\"[data-week]\");\n  var weekDays = work.dataset.week.split(\",\").map(Number);\n  var weekHour = work.dataset.time.split(\",\").map(Number);\n  var nowDate = new Date();\n  var dayNow = nowDate.getDay();\n  var timeNow = nowDate.getHours();\n  var openDay = weekDays.indexOf(dayNow) !== -1;\n  var openTime = timeNow >= weekHour[0] && timeNow < weekHour[1];\n  if (openDay && openTime) {\n    work.classList.add(\"open\");\n  }\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/work-hour.js?");
